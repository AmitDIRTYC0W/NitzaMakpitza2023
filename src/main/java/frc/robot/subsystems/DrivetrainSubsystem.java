...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  private final CANSparkMax flSteeringMotor = new CANSparkMax(Ports.Swerve.FRONT_LEFT_STEERING_MOTOR);
  ...
  private final CANSparkMax frSteeringMotor = new CANSparkMax(Ports.Swerve.FRONT_RIGHT_STEERING_MOTOR);
  ...
  private final CANSparkMax rlSteeringMotor = new CANSparkMax(Ports.Swerve.REAR_LEFT_STEERING_MOTOR);
  ...
  private final CANSparkMax rrSteeringMotor = new CANSparkMax(Ports.Swerve.REAR_RIGHT_STEERING_MOTOR);
